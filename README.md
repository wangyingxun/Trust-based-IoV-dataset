...
# A specimen of the envisaged trust-based IoV dataset encompassing the trust parameters, i.e., IExp -- Experience of Interaction, IFre -- Frequency of Interaction, ITim -- Timeliness of Interaction, and RMQ -- Quality of Received Messages, and labels, i.e., MaliciousVehicle and IsAttacking.
